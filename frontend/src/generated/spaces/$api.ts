...
// prettier-ignore
import { Methods as Methods4 } from './_space_id@string/content_models'
// prettier-ignore
import { Methods as Methods5 } from './_space_id@string/content_models/_content_id@string/content_fields/_content_field_id@string'
// prettier-ignore
import { Methods as Methods6 } from './_space_id@string/content_models/_content_model_id@string'
// prettier-ignore
import { Methods as Methods7 } from './_space_id@string/content_models/_content_model_id@string/content_fields'
// prettier-ignore
import { Methods as Methods8 } from './_space_id@string/content_models/_content_model_id@string/contents'
// prettier-ignore
import { Methods as Methods9 } from './_space_id@string/content_models/_content_model_id@string/contents/_content_id@string'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH2 = '/content_models'
  const PATH3 = '/content_fields'
  const PATH4 = '/contents'
  const GET = 'GET'
  const POST = 'POST'
  const DELETE = 'DELETE'
  const PATCH = 'PATCH'
                ...
                _content_field_id: (val4: string) => {
                  ...
                  return {
                    ...
                    patch: (option: { body: Methods5['patch']['reqBody'], config?: T }) =>
                      fetch<Methods5['patch']['resBody'], BasicHeaders, Methods5['patch']['status']>(prefix, prefix4, PATCH, option).json(),
                    /**
                     * コンテンツモデル内のコンテンツフィールドIDに紐づく、コンテンツフィールドを更新します。
                     *
                     * ### 公開範囲
                     ...
                     */
                    $patch: (option: { body: Methods5['patch']['reqBody'], config?: T }) =>
                      fetch<Methods5['patch']['resBody'], BasicHeaders, Methods5['patch']['status']>(prefix, prefix4, PATCH, option).json().then(r => r.body),
                    /**
          ...
          _content_model_id: (val2: string) => {
            ...
            return {
              content_fields: {
                 ...
                 */
                get: (option?: { config?: T }) =>
                  fetch<Methods7['get']['resBody'], BasicHeaders, Methods7['get']['status']>(prefix, `${prefix2}${PATH3}`, GET, option).json(),
                /**
                 * コンテンツモデル内のコンテンツフィールド一覧を取得します。
                 *
                 * ### 公開範囲
                 ...
                 */
                $get: (option?: { config?: T }) =>
                  fetch<Methods7['get']['resBody'], BasicHeaders, Methods7['get']['status']>(prefix, `${prefix2}${PATH3}`, GET, option).json().then(r => r.body),
                /**
                ...
                post: (option: { body: Methods7['post']['reqBody'], config?: T }) =>
                  fetch<Methods7['post']['resBody'], BasicHeaders, Methods7['post']['status']>(prefix, `${prefix2}${PATH3}`, POST, option).json(),
                /**
                 * コンテンツモデル内に、コンテンツフィールドを新規作成します。
                 *
                 * ### 公開範囲
                 ...
                 */
                $post: (option: { body: Methods7['post']['reqBody'], config?: T }) =>
                  fetch<Methods7['post']['resBody'], BasicHeaders, Methods7['post']['status']>(prefix, `${prefix2}${PATH3}`, POST, option).json().then(r => r.body),
              ...
              contents: {
                _content_id: (val4: string) => {
                  ...
                  return {
                    ...
                    patch: (option?: { config?: T }) =>
                      fetch<Methods9['patch']['resBody'], BasicHeaders, Methods9['patch']['status']>(prefix, prefix4, PATCH, option).json(),
                    /**
                     * コンテンツIDに紐づく、コンテンツの情報を更新します。
                     *
                     * ### 公開範囲
                     ...
                     */
                    $patch: (option?: { config?: T }) =>
                      fetch<Methods9['patch']['resBody'], BasicHeaders, Methods9['patch']['status']>(prefix, prefix4, PATCH, option).json().then(r => r.body),
                    /**
                ...
                get: (option: { query: Methods8['get']['query'], config?: T }) =>
                  fetch<Methods8['get']['resBody'], BasicHeaders, Methods8['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json(),
                /**
                 * スペースのコンテンツモデルIDに紐づく、コンテンツ一覧を取得します。
                 *
                 * ### 公開範囲
                 ...
                 */
                $get: (option: { query: Methods8['get']['query'], config?: T }) =>
                  fetch<Methods8['get']['resBody'], BasicHeaders, Methods8['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json().then(r => r.body),
                /**
                ...
                post: (option: { body: Methods8['post']['reqBody'], config?: T }) =>
                  fetch<Methods8['post']['resBody'], BasicHeaders, Methods8['post']['status']>(prefix, `${prefix2}${PATH4}`, POST, option).json(),
                /**
                 * スペース内のコンテンツモデルIDに紐づく、コンテンツモデルにコンテンツを新規作成します。
                 *
                 * ### 公開範囲
                 ...
                 */
                $post: (option: { body: Methods8['post']['reqBody'], config?: T }) =>
                  fetch<Methods8['post']['resBody'], BasicHeaders, Methods8['post']['status']>(prefix, `${prefix2}${PATH4}`, POST, option).json().then(r => r.body),
              ...
              patch: (option: { body: Methods6['patch']['reqBody'], config?: T }) =>
                fetch<Methods6['patch']['resBody'], BasicHeaders, Methods6['patch']['status']>(prefix, prefix2, PATCH, option).json(),
              /**
               * スペース内のコンテンツモデルIDい紐づく、コンテンツモデルの情報を更新します。
               *
               * ### 公開範囲
               ...
               */
              $patch: (option: { body: Methods6['patch']['reqBody'], config?: T }) =>
                fetch<Methods6['patch']['resBody'], BasicHeaders, Methods6['patch']['status']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
              /**
